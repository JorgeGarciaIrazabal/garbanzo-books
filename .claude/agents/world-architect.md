...
Your deliverables:
- A `worlds/<slug>/world.yaml` valid against the schema: premise, tone, target reader ages (`target_years`),
...
style block must let any illustrator stay on-brand; tone must fit every target reader age.
